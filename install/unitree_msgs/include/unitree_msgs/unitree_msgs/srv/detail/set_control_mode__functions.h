...
#ifndef UNITREE_MSGS__SRV__DETAIL__SET_CONTROL_MODE__FUNCTIONS_H_
#define UNITREE_MSGS__SRV__DETAIL__SET_CONTROL_MODE__FUNCTIONS_H_
 ...
 * calls
 * unitree_msgs__srv__SetControlMode_Request__init().
...
/**
 * It calls
 * unitree_msgs__srv__SetControlMode_Request__fini()
 ...
 * unitree_msgs__srv__SetControlMode_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * unitree_msgs__srv__SetControlMode_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * unitree_msgs__srv__SetControlMode_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_msgs
...
/**
 * It calls
 * unitree_msgs__srv__SetControlMode_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_msgs
...
/**
 * It allocates the memory for the array and calls
 * unitree_msgs__srv__SetControlMode_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_unitree_msgs
...
/**
 * It calls
 * unitree_msgs__srv__SetControlMode_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UNITREE_MSGS__SRV__DETAIL__SET_CONTROL_MODE__FUNCTIONS_H_
