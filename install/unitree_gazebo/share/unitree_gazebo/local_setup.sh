...
: ${AMENT_CURRENT_PREFIX:="/home/agro/unitree_ros2/install/unitree_gazebo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/unitree_gazebo/environment/library_path.sh"
